...
// Query: *[_type == "footer"][0]{    _id,    logo {      asset->{        url,        extension,        mimeType      },      alt    },    companyName,    linkColumns[] {      title,      links[] {        text,        "slug": page->slug.current      }    },    infoLinks[] {      text,      "slug": page->slug.current    }  }
